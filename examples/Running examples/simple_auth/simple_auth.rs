...
use ::rumpsteak::{
    channel::Bidirectional, effect::Constant, effect::Incr, predicate::LTnConst,
    predicate::Tautology, session, try_session, Branch, End, Message, Receive, Role, Roles, Select,
    Send,
};
...
type ProtoC = Receive<
    ...
    Send<
        ...
        Tautology<Name, Value>,
        Constant<Name, Value>,
        Branch<S, Tautology<Name, Value>, Constant<Name, Value>, ProtoC3>,
    >,
>;
...
type ProtoS = Send<
    ...
    Receive<
        ...
        LTnConst<'r', 0>,
        Incr<'r', 1>,
        Select<C, Tautology<Name, Value>, Constant<Name, Value>, ProtoS3>,
    >,
>;
